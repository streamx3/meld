            ...
            if self.auto_merge and out0[0] == 'conflict':
                ...
                if (len0 > 0 and len2 > 0) and (len0 == len1 or len2 == len1 or len1 == 0):
                    ...
                    if chunktype == 'delete':
                        ...
                        seq0 = seq1 = None
                        # i0/i1/end0/end1 are always bound before use: both
                        # using-lists are non-empty on entry, so the first
                        # loop pass assigns them before any break can occur
                        while True:
                            if seq0 is None:
                                try:
                                    seq0 = using[0].pop(0)
                        ...
                        if seq0:
                            ...
                            out0 = ('conflict', i0, i0 + seq1[2] - i1, end0, end0 + seq1[2] - i1)
